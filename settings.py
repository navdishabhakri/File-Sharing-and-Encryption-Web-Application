...
SECRET_KEY = "django-insecure-pv4xwmear)#18r!6gy=$gy0@xrcq#yrg4ib9$r7^=!*=v0o5#7"
...
MEDIA_ROOT = BASE_DIR / 'media'
  ...
  # This ensures the media files are stored in the 'media' directory at the project root

# Redirect URL after login
LOGIN_REDIRECT_URL = '/'


LOGIN_URL = 'login'  # This will tell Django to use the login URL defined in your urls.py
...
if not ENCRYPTION_KEY:
    raise ValueError("ENCRYPTION_KEY not found in the environment variables!")
